...
//if ts throw error about duplicate variable name
//because somewhere in project it exist
//we have a little trick to scope our script tag
//import {} from '#app' //it will fix it issue
...
useSeoMeta({
  title: restaurant ? restaurant.name : '404',
});
</script>
